...
function WalletManager(): JSX.Element {
  ...
  return (
    <div data-testid="wallet">
      {account !== "" ? (
        <div className="flex items-center" data-testid="wallet-details">
          <div
          ...
          >
            ...
            <span data-testid="wallet-chainname" className="block">
              {chainInfo.chainName}
            </span>
          </div>
          <div className="font-mono flex bg-gray-200 dark:bg-gray-600 rounded-xl pl-3 pr-[2px] py-[2px] items-center">
            ...
            <div className="flex items-center ml-3 bg-gray-300/70 dark:bg-gray-700 py-1 rounded-xl pl-2 pr-2">
              <div data-testid="wallet-address">{`${account.slice(
                0,
                6
              )}...${account.slice(account.length - 4, account.length)}`}</div>
              <div
                ref={identiconRef}
        ...
        <button
          ...
          className="rounded-xl bg-gradient-to-r from-red-400 to-red-500 hover:from-red-500 hover:to-red-600 block px-4 py-2 font-bold text-sm"
        >
          Connect to a wallet
        </button>
      )}
